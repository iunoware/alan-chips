      ...
      <div className="min-h-screen pt-32 pb-20 bg-neutral-50 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <div className="bg-white p-12 rounded-3xl shadow-sm border border-neutral-100 max-w-lg mx-auto">
            ...
            <h1 className="text-3xl font-black text-neutral-900 mb-4 text-center">
              Your cart is empty
            </h1>
            <p className="text-neutral-500 mb-8 max-w-sm mx-auto">
              Look like you haven't added anything to your cart yet. Explore our
              delicious chips and snacks!
            </p>
            <Link
              href="/chips"
    ...
    <div className="min-h-screen pt-32 pb-20 bg-neutral-50 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-10">
          <Link
            href="/chips"
            className="p-2 bg-white rounded-full shadow-sm hover:text-green-700 transition-colors"
          >
            <ArrowLeft size={20} />
          </Link>
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex items-center justify-center md:justify-start gap-6">
                    ...
                    <div className="flex items-center bg-neutral-100 rounded-xl p-1 gap-4">
                      ...
                      <span className="font-bold text-neutral-900 min-w-[2ch] text-center">
                        {item.quantity}
                      </span>
                      <button
                        onClick={() =>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-8 rounded-3xl border border-neutral-100 shadow-sm sticky top-32">
              ...
              <div className="flex justify-between items-center mb-10">
                <span className="text-xl font-black text-neutral-900 uppercase tracking-tight">
                  Total
                </span>
              ...
              <button
                ...
                className="w-full bg-neutral-900 text-white font-bold py-5 rounded-2xl flex items-center justify-center gap-3 hover:bg-green-700 transition-all active:scale-[0.98] shadow-lg mb-4"
              >
                Proceed to Checkout
              </button>
