...
const dishes1 = [
  {
    ...
    description:
      "Crunchy plantain slices coated in a vibrant masala blend, delivering a perfect balance of spice, aroma, and authentic South Indian flavour.",
  ...
  },
  {
    ...
    description:
      "A refreshing twist on a classic. Crispy potato chips infused with minty freshness and subtle spices for a cool, flavour-packed crunch.",
  ...
  },
  {
    ...
    description:
      "Distinctively cut and lightly spiced, these sweet plantain chips offer a layered crunch with just the right hint of seasoning.",
