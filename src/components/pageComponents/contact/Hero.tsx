...
const Hero = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative overflow-x-clip bg-[url('/images/traditional-snacks-in-tenkasi.webp')] pt-40 pb-20 md:pt-56 md:pb-32 px-6 flex flex-col items-center text-center bg-[#FAF9F6]"
    >
      <div ref={textRef} className="max-w-4xl mx-auto">
        ...
        <p className="hero-subtext text-lg md:text-xl text-black/60 font-sans max-w-2xl mx-auto leading-relaxed">
          Whether you’re a long-time customer, a potential partner, or a
          distributor looking to join our legacy, we welcome your enquiry. Our
          team is here to listen and assist.
        </p>
      </div>
